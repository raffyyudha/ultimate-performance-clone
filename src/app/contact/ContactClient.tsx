      ...
      <section className="relative h-[320px] md:h-[400px] w-full flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto space-y-3 animate-fadeIn">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-white leading-tight">
            {content?.hero_title ?? "Begin Your Journey"}
          </h1>
          <p className="text-gray-300 mt-2 text-sm md:text-base max-w-xl mx-auto leading-relaxed font-medium">
            {content?.hero_description ?? "Fill out the consultation form below or connect directly with us via WhatsApp to start your lifestyle progression."}
          </p>
        </div>
      </section>
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-black leading-tight">
              {content?.form_title ?? "Corporate & Personal Enquiries"}
            </h2>
            <p className="text-gray-600 text-sm leading-relaxed max-w-md font-medium">
              {content?.form_description ?? "Quatre Fitness Group Pte Ltd is based in Singapore, delivering premium personal coaching, apparel collections, and nutrition systems directly to your location."}
            </p>
          </div>
          ...
          <div className="space-y-4 pt-4 border-t border-gray-200/80">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 flex gap-4 hover:shadow-md transition-all duration-300">
              ...
              <div className="space-y-1">
                <h4 className="font-extrabold text-[10px] uppercase tracking-wider text-gray-400">
                  WhatsApp Hot Line
                </h4>
                <p className="text-sm">
                  <a
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 flex gap-4 hover:shadow-md transition-all duration-300">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-extrabold text-gray-700 tracking-wide">
                  support@dquatre.com
                </p>
                <p className="text-[10px] text-gray-400 font-semibold">
                  Mon-Sun, 5 AM - 10 PM Singapore Time
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-7">
          {submitted ? (
            <div className="bg-white p-10 rounded-[2rem] shadow-md border border-gray-100 text-center space-y-6 animate-fadeIn">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-500 text-sm max-w-md mx-auto leading-relaxed font-semibold">
                  Your consultation request for training at{" "}
                  <strong>{formData.location}</strong> has been received. A
                  Quatre Fitness coach will contact you within 24 hours.
                </p>
              </div>
              <div className="bg-[#F5F5F7] p-5 rounded-2xl text-left text-xs text-gray-600 max-w-md mx-auto space-y-3 border border-gray-200/50">
                <p className="font-extrabold text-black border-b border-gray-200 pb-1.5 mb-2 uppercase tracking-wider">
                  Summary of request:
                </p>
                {formData.goals.length > 0 ? (
                  ...
                  <p className="font-semibold">
                    General training & health consultation.
                  </p>
                )}
            ...
            <form
              ...
              className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-sm border border-gray-100 space-y-6"
            >
              ...
              <div>
                <span className="block text-xs font-extrabold text-black uppercase tracking-wider mb-3">
