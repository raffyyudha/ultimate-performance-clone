...
export default function ResultsClient({ content }: ResultsClientProps) {
  ...
  const transformations: Transformation[] = [
    {
      ...
      story:
        "Before joining Quatre Fitness, I felt fatigued and had tried countless crash diets that never lasted. My dedicated coach rebuilt my nutrition from scratch, tailoring it to my active lifestyle at age 51. The private training was progressive, structured, and fit into my busy corporate schedule.",
    },
    {
      name: "Seng",
      age: 57,
      ...
      img: "/result2.jpeg",
      quote:
        "I thought age was a barrier. Quatre Fitness proved me completely wrong.",
      story:
        "I had knee pain and high cholesterol when I first started. The coaches developed a joint-friendly, strength-focused mobile program that completely rehabilitated my movement. I am now in the best shape of my life at age 57.",
    },
    {
      name: "Ah Chuan",
      age: 34,
      ...
      story:
        "Losing over 50kg seemed like an impossible task. The secret was the absolute accountability. My coach checked in on my food and supplement diary every single day, keeping me focused. We did not use any extreme methods, just steady, scientific progression.",
    },
    {
      name: "David",
      age: 29,
      ...
      story:
        "I wanted to break through a strength plateau. Quatre Fitness's focus on progressive overload, mechanical execution, and high-quality FitLine supplementation helped me gain clean lean muscle without gaining excess body fat.",
    },
    {
      name: "Jun",
      age: 46,
      ...
      story:
        "As a busy father, I put my health on the back burner. The mobile training program taught me how to incorporate clean macros and resistance training into my life. My posture has improved dramatically and my daily energy is amazing.",
    },
    {
      name: "Wei",
      age: 42,
      ...
      story:
        "I did not believe a transformation could be done in under 3 hours a week of home/condo training. By focusing on high-effort training and meticulous nutritional control, we achieved a total body recomposition in just 90 days.",
    },
  ];
    ...
    <main className="min-h-screen bg-cream pt-20">
      ...
      <section className="grid md:grid-cols-12 items-stretch gap-0 bg-white border-b border-gray-200 overflow-hidden">
        <div className="col-span-12 md:col-span-5 px-6 py-16 md:px-12 lg:px-16 flex flex-col justify-center bg-cream">
          <p className="text-xs text-maroon font-bold uppercase tracking-widest mb-3">
            PROOF OF RESULTS
          </p>
          <h1 className="font-bold text-4xl md:text-5xl lg:text-6xl text-black leading-tight mb-6 tracking-tight">
            {content?.hero_title ?? "Exceptional results.\nDelivered as standard."}
          </h1>
          <p className="text-gray-500 text-sm leading-relaxed max-w-md">
            {content?.hero_description ?? "Use the filters below to explore results by sex, age, and timeframe. Or hear what our clients say about the Quatre Fitness experience in their own words."}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredItems.map((client) => {
            ...
            return (
              <div
                key={client.name}
                className="bg-white rounded-lg overflow-hidden shadow-md border border-gray-100 hover:shadow-lg transition-shadow duration-300 flex flex-col justify-between"
              >
                <div>
                  {/* Image wrapper */}
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-xs text-gray-400 font-semibold mt-1">
                          Age: {client.age} | Duration: {client.timeline}
                        </p>
                      </div>
