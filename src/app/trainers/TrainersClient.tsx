...
export default function TrainersClient({ content }: TrainersClientProps) {
      ...
      <section className="relative h-[480px] w-full flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-white leading-tight">
            {content?.hero_title ?? "Our trainers"}
          </h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-6 space-y-6 md:pl-6">
            ...
            <div className="space-y-4 text-gray-600 text-sm md:text-base leading-relaxed">
              <p>
                We don't hire ordinary personal trainers. We hand-select the
                best, develop them through 200+ hours of advanced learning every
                year, and hold them to the highest standards in the industry.
              </p>
              <p>
                Every trainer is measured on one thing alone: the quality of
                outcome they deliver for you, and for every client they work
                with.
              </p>
            </div>
            <div className="pt-4">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-6 space-y-6 order-2 md:order-1">
            ...
            <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
              ...
              <p>
                Every candidate goes through a six-stage recruitment process
                designed to test far more than technical skill. We look for
                trainers who are obsessed with results, thrive in a
                high-standards team environment, and take their clients'
                progress personally.
              </p>
              <p>
                When you work with a Quatre Fitness trainer, you're not choosing
                from a marketplace where quality is impossible to judge. You're
                being matched with one of the most rigorously selected coaching
      ...
      <section className="bg-white py-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-6 space-y-6 md:pl-6">
            ...
            <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
              <p className="font-semibold text-black">
                Most personal trainers complete a short qualification, and
                that's where learning stops. At Quatre Fitness, development is
                continuous and non-negotiable.
              </p>
              <p>
                In their first year alone, every trainer completes over 200
                hours of structured education. Case studies. Assessments.
                Mentorship. Team training. Practical application. All designed
                to embed the Quatre Fitness Method and the standards required to
                deliver consistently at the highest level.
              </p>
              <p>
                This means you work with a trainer operating at the leading edge
                of the industry. And you'll feel the difference.
              </p>
            </div>
            <div className="pt-4">
              <Link
      ...
      <section className="bg-[#F5F5F7] py-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-6 space-y-6 order-2 md:order-1">
            ...
            <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
              <p className="font-semibold text-black">
                We remove the distractions most personal trainers face. No
                selling. No marketing. No chasing leads.
              </p>
              <p>
                Your trainer's singular focus is mastering their craft and
                delivering the best results possible for you. Our trainers are
                measured, rewarded, and promoted based purely on the quality of
                outcomes they produce.
              </p>
              <p>
                What that means for you is simple. You get a coach whose full
                attention is exactly where it should be. On the details and
                decisions that drive your progress.
              </p>
            </div>
          </div>
      ...
      <section className="bg-white py-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-6 space-y-6 md:pl-6">
            ...
            <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
              <p>
                Your trainer is responsible for your results. And behind them is
                a leadership structure that supports, challenges, and maintains
                the standards that make those results possible.
              </p>
              <p>
                Trainers at Quatre Fitness are measured on outcomes, not hours
                worked or sessions sold. Progress is constantly tracked,
                performance is monitored, and when momentum slows, we step in to
                adjust your plan judiciously.
              </p>
              <p className="font-semibold text-black">
                This level of accountability doesn't exist in any other personal
                training environment. And it shows in the outcomes: 97% of
                Quatre Fitness clients achieve their goals, compared to 70% who
                fall short with other methods.
              </p>
              <p>
                We don't let standards slip. We don't let progress drift. And we
                never leave your results to chance.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#F5F5F7] py-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-6 space-y-6 order-2 md:order-1">
            ...
            <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
              <p>
                We equip your trainer with advanced data-tracking tools to
                remove guesswork from the process. Your progress across
                training, nutrition, recovery, and daily habits is tracked
                clearly and consistently.
              </p>
              <p className="font-semibold text-black">
                But data alone doesn't drive results. What matters is how your
                trainer analyses it, interprets it, and applies it intelligently
                to your life.
              </p>
              <p>
                If sleep is disrupted, they notice. If appetite spikes, they
                explore why. If training plateaus, they adapt the approach with
                precision.
              </p>
              <p>
                The result is clarity and confidence. You know what's working,
                why it's working, and how each decision supports your progress.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-6 relative h-[300px] md:h-[480px] w-full rounded-3xl overflow-hidden shadow-lg border border-gray-100 order-1 md:order-2">
            ...
            <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm p-4 rounded-xl shadow-xl max-w-[240px] text-xs border border-gray-100/50 space-y-3 animate-in fade-in slide-in-from-top-4 duration-500">
              <div className="flex justify-between items-center border-b border-gray-100 pb-2">
                ...
                <span className="bg-[#1E00FA] text-white text-[9px] font-bold px-1.5 py-0.5 rounded uppercase">
                  LIVE
                </span>
              </div>
