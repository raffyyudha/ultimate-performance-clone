...
export default function ServicesClient({ content }: ServicesClientProps) {
  ...
  const doubtsSlides = [
    {
      ...
      story:
        "Ah Chuan trusted the Quatre Fitness Method, followed the process step by step, and lost 53kg (117lbs) and transformed his long-term health.",
    ...
    },
    {
      ...
      story:
        "Seng started at 57, trained with a customized mobile program, lost 40kg, and built significant muscle definition while eliminating joint pain.",
      name: "SENG'S STORY",
      link: "/results",
      img: "/result2.jpeg",
    },
    {
      ...
      story:
        "Hendra integrated 3 hours of weekly training with our nutrition system and lost 21kg without sacrificing his executive career.",
      name: "HENDRA'S STORY",
      link: "/results",
      img: "/result1.jpeg",
    },
    {
      ...
      story:
        "Jun overcame chronic back issues, improved his posture, and lost 14kg under close coaching supervision.",
      name: "JUN'S STORY",
      link: "/results",
      img: "/result5.jpeg",
    },
  ...
  const handlePrevSlide = () => {
    setActiveSlide(
      (prev) => (prev - 1 + doubtsSlides.length) % doubtsSlides.length,
    );
  };
  ...
  return (
    <main className="min-h-screen bg-[#F5F5F7] text-[#1A1A1A] font-sans antialiased">
      ...
      <section className="relative h-[480px] w-full flex items-center justify-center bg-black overflow-hidden">
        <Image
          src={content?.hero_image ?? "/contact_hero.png"}
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-white leading-tight">
            {content?.hero_title ?? "Personal training at Quatre Fitness"}
          </h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-8 space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight leading-tight">
              {content?.intro_title ?? "The world's most effective personal training method"}
            </h2>
            <div className="space-y-4 text-gray-600 text-sm md:text-base leading-relaxed max-w-3xl">
              <p>
                {content?.intro_p1 ?? "We don't do fads, fashion, or quick fixes. We deliver life-changing results. Quatre Fitness is the premium personal training group built for clients who want structure, evidence-based training, and total accountability."}
              </p>
              <p>
                {content?.intro_p2 ?? "Our home and mobile personal training programs in Singapore are designed to make your goals inevitable. Whether you want to lose weight, build strength, rehab an injury, or improve your longevity, we manage every variable of your training, nutrition, and lifestyle to guarantee progress."}
              </p>
            </div>
          </div>
      ...
      <section className="bg-[#F5F5F7] py-20">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
            {content?.system_title ?? "Everything you need – in one proven system"}
          </h2>
          <p className="text-gray-500 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            {content?.system_description ?? "We leave nothing to chance. Your results are guaranteed through our comprehensive approach to training, nutrition, tracking, and daily accountability."}
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                No generic templates. Your coach builds a customized roadmap
                based on your initial strength, body composition, and movement
                analysis.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <h3 className="text-lg font-bold">
                Precision training, tailored to you
              </h3>
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                Every workout is supervised, tracked, and modified dynamically
                to ensure safe progressive overload and optimal mechanical
                tension.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                A bespoke nutrition protocol designed for your lifestyle. No
                starving, just clear, sustainable dietary changes paired with
                premium German FitLine supplements.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <h3 className="text-lg font-bold">
                Accountability that drives your progress
              </h3>
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                Daily check-ins, food diary monitoring, and constant
                communication with your coach keep you focused and motivated
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                We track every lift, calorie, and bio-marker to monitor your
                rate of progress and make precise adjustments based on real
                metrics.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                24/7 access to your coach. We provide the advice, guidance, and
                adjustments you need to stay on track, even when traveling or
                dining out.
              </p>
            </div>
          </div>
      ...
      <section className="bg-white py-20 border-t border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
            {content?.process_title ?? "How personal training works at Quatre Fitness"}
          </h2>
          <p className="text-gray-500 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            {content?.process_description ?? "Our step-by-step process is designed to support you from day one to the day you achieve your goal."}
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-6 mt-16 space-y-12">
          ...
          <div className="flex gap-6 items-start relative pb-6 border-l border-dashed border-gray-200 pl-6 ml-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                We analyze your health history, joint mobility, body
                composition, and daily schedule to build your baseline profile.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-6 items-start relative pb-6 border-l border-dashed border-gray-200 pl-6 ml-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                You are matched with an elite coach who takes 100% ownership of
                your results, managing your programming, nutrition, and habits.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-6 items-start relative pb-6 border-l border-dashed border-gray-200 pl-6 ml-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                We design a detailed workout and dietary plan tailored to your
                specific biomechanics, food preferences, and availability.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-6 items-start relative pb-6 border-l border-dashed border-gray-200 pl-6 ml-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                Focus on perfect execution and intensity. Your coach guides you
                through every session, optimizing mechanical load and safety.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-6 items-start relative pl-6 ml-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
                Weekly weight, measurement, and strength tracking allow us to
                adjust variables continuously, ensuring you never hit a plateau.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#F5F5F7] py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
            <div className="space-y-4">
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
                {content?.results_title ?? "Thousands of clients. Predictable progress. Proven results."}
              </h2>
              <p className="text-gray-500 text-sm md:text-base leading-relaxed max-w-2xl">
                {content?.results_description ?? "We help people achieve life-changing physical results with no guesswork. Explore some of our local client success stories."}
              </p>
            </div>
            <div>
              <Link
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <div className="p-5 space-y-2">
                ...
                <p className="text-[#1E00FA] text-xs font-bold uppercase tracking-wider">
                  Lost 21kg & 18% body fat
                </p>
      ...
      <section className="bg-white py-20 border-t border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
            {content?.science_title ?? "Backed by science. Driven by data."}
          </h2>
          <p className="text-gray-500 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            {content?.science_description ?? "We collect metrics from thousands of training sessions to design the most effective programs. Our statistics speak for themselves."}
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#F5F5F7] p-8 rounded-2xl border border-gray-100 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <p className="text-3xl md:text-4xl font-extrabold text-[#1E00FA]">
                  92.6%
                </p>
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                Measured through composite tracking of major compound movements
          ...
          <div className="bg-[#F5F5F7] p-8 rounded-2xl border border-gray-100 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                Achieved by our fat loss clients following our custom nutrition
                plans for a 12-week block.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#F5F5F7] p-8 rounded-2xl border border-gray-100 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                Measured in hypertensive clients after adopting consistent
                resistance training and mineral control.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#F5F5F7] p-8 rounded-2xl border border-gray-100 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                Self-reported marker improvement resulting from natural hormone
                optimization and fat reduction.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#F5F5F7] p-8 rounded-2xl border border-gray-100 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                Significant decrease in stress hormones and increase in sleep
                quality metrics.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#F5F5F7] p-8 rounded-2xl border border-gray-100 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                Clients who continue tracking and follow maintenance protocols
                retain their body recomposition permanently.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 mt-8 text-center">
          <p className="text-gray-400 text-[10px] italic">
            *Based on strength (1RM) and health marker studies tracking Quatre
            Fitness clients over 12-week cycles. Individual results may vary.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
              {content?.tracking_title ?? "Real-time progress, support, and guidance"}
            </h2>
            <div className="text-gray-600 text-sm md:text-base leading-relaxed space-y-4">
              <p>
                Our structured tracking method keeps you directly connected to
                your coach, who logs every workout, tracks nutrition and
                supplements (including PM International FitLine protocols), and
                visualizes your progress metrics.
              </p>
              <p>
                Having your training log, progress pictures, strength curves,
                and dietary tracking compiled and managed systematically
                eliminates guesswork and maximizes efficiency.
              </p>
            </div>
          </div>
          <div className="relative h-[400px] md:h-[480px] w-full rounded-3xl overflow-hidden shadow-lg border border-gray-100">
            <Image
              src={content?.tracking_image ?? "/goal_weight_management.png"}
      ...
      <section className="bg-white py-20 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-6">
          ...
          <div className="text-gray-600 text-sm md:text-base leading-relaxed space-y-4 max-w-3xl mx-auto">
            <p>
              It's normal to question whether personal training will work for
              you. Almost every client we work with had doubts before they
              started – about age, fitness level, past experiences, injuries, or
              their ability to stay consistent.
            </p>
            <p>
              What they discovered is that following a structured process,
              guided by an expert at Quatre Fitness, removed uncertainty and
              helped them confidently achieve results. Below are some of the
              most common doubts clients arrive with – and how the process
              worked for them.
            </p>
          </div>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-gray-600 text-xs md:text-sm leading-relaxed space-y-3">
                    ...
                    <p className="font-semibold text-black">
                      {doubtsSlides[activeSlide].story}
                    </p>
                  </div>
                </div>
