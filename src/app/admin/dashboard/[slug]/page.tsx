...
const PAGE_FIELDS: Record<string, { label: string; fields: FieldDef[] }> = {
  home: {
    ...
    fields: [
      ...
      { key: "pillar1_image", label: "Pillar 1 Image Path/URL", type: "text", placeholder: "/WhatsApp Image 2026-06-19 at 10.29.03 PM (1).jpeg" },
      ...
      { key: "pillar2_image", label: "Pillar 2 Image Path/URL", type: "text", placeholder: "/WhatsApp Image 2026-06-19 at 10.42.50 PM.jpeg" },
      ...
      { key: "pillar4_image", label: "Pillar 4 Image Path/URL", type: "text", placeholder: "/WhatsApp Image 2026-06-19 at 10.29.03 PM (3).jpeg" },
  ...
  about: {
    ...
    fields: [
      ...
      { key: "method_image", label: "Method Showcase Image Path/URL", type: "text", placeholder: "/WhatsApp Image 2026-06-23 at 1.53.30 PM.jpeg" },
