      ...
      <section className="relative h-[65vh] flex items-center bg-black text-white overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12 w-full">
          ...
          <p className="text-gray-300 mt-4 text-sm md:text-base max-w-md leading-relaxed">
            Upgrade your health, energy, and recovery with FitLine by PM International—nutritional supplements built on the patented Nutrient Transport Concept (NTC®).
          </p>
        </div>
      </section>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          ...
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
            The Nutrient Transport Concept (NTC®)
          </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-gray-500 text-sm">
              Explore the premium, clinically designed core products that we integrate into our client programs.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {products.map((prod) => (
              <div key={prod.name} className="bg-[#F5F5F7] rounded-3xl overflow-hidden border border-gray-100 flex flex-col justify-between hover:shadow-md transition-shadow duration-300">
                <div>
                  ...
                  <div className="p-8 space-y-4">
                    ...
                    <div className="space-y-1">
                      <h3 className="text-xl font-bold text-black">{prod.name}</h3>
                      <p className="text-xs text-gray-400 italic">{prod.tagline}</p>
                    </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {focusAreas.map((area) => (
            <div key={area.title} className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 space-y-4 flex flex-col justify-between">
              ...
              <p className="text-gray-500 text-xs md:text-sm leading-relaxed">{area.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-[#F5F5F7] py-24 border-t border-gray-200">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-6">
          ...
          <p className="text-gray-600 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            We believe premium training deserves premium nutrition. Supplements are not shortcuts—they are part of a smart, structured lifestyle system supporting long-term health and physical performance.
          </p>
          <div className="pt-4">
            <Link
              href="/contact"
