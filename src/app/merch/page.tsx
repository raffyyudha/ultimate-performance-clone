...
export default function QuatreMerchPage() {
  const values = [
    {
      title: "Performance",
  ...
  const products = [
    ...
    },
    {
      ...
      waText: "Hi Quatre, I would like to enquire about the Quatre \"Undefeated\" Premium Gift Box (SGD 150.00)."
    },
    {
      ...
      waText: "Hi Quatre, I would like to enquire about the Quatre \"Stronger\" Premium Gift Box (SGD 150.00)."
    }
  ];
      ...
      <section className="relative h-[65vh] flex items-center bg-black text-white overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12 w-full">
          ...
          <p className="text-gray-300 mt-4 text-sm md:text-base max-w-md leading-relaxed">
            Premium fitness & lifestyle apparel designed for individuals who live by performance, comfort, and modern style.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-gray-500 text-sm">
              Premium materials, tailored fit, and absolute durability. Click to enquire stock and sizes directly on WhatsApp.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {products.map((prod) => (
              <div key={prod.title} className="bg-[#F5F5F7] rounded-3xl overflow-hidden border border-gray-100 flex flex-col justify-between hover:shadow-md transition-shadow duration-300">
                <div>
