...
export default function CalculatorClient({ content }: CalculatorClientProps) {
  ...
  const bmi =
    heightInMeters > 0
      ? parseFloat((w / (heightInMeters * heightInMeters)).toFixed(1))
      : 0;
    ...
    if (diff > 0 && h > 0) {
      bodyFat = parseFloat(
        (
          ...
          70.041 * Math.log10(heightInMeters * 100) +
          36.76
        ).toFixed(1),
      );
    }
  ...
  if (gender === "male") {
    if (whr < 0.9) {
      whrRisk = "Low Risk";
      whrColor = "text-emerald-400";
    } else if (whr >= 0.9 && whr < 1.0) {
      whrRisk = "Moderate Risk";
      whrColor = "text-yellow-400";
    } else {
      whrRisk = "High Risk";
  ...
  const thrZones = [
    {
      zone: "Zone 1: Warm Up",
      pct: "50-60%",
      range: `${Math.round(hrr * 0.5 + rh)} - ${Math.round(hrr * 0.6 + rh)}`,
      color: "border-sky-500/20 text-sky-400 bg-sky-500/5",
      desc: "Recovery training, cardiovascular prep",
    },
    {
      zone: "Zone 2: Fat Burn",
      pct: "60-70%",
      range: `${Math.round(hrr * 0.6 + rh)} - ${Math.round(hrr * 0.7 + rh)}`,
      color: "border-emerald-500/20 text-emerald-400 bg-emerald-500/5",
      desc: "Optimal lipid metabolism, endurance",
    },
    {
      zone: "Zone 3: Cardio/Aerobic",
      pct: "70-80%",
      range: `${Math.round(hrr * 0.7 + rh)} - ${Math.round(hrr * 0.8 + rh)}`,
      color: "border-yellow-500/20 text-yellow-400 bg-yellow-500/5",
      desc: "Aerobic fitness, heart stroke volume",
    },
    {
      zone: "Zone 4: Anaerobic",
      pct: "80-90%",
      range: `${Math.round(hrr * 0.8 + rh)} - ${Math.round(hrr * 0.9 + rh)}`,
      color: "border-orange-500/20 text-orange-400 bg-orange-500/5",
      desc: "Lactate threshold builder, speed strength",
    },
    {
      zone: "Zone 5: Max Effort",
      pct: "90-100%",
      range: `${Math.round(hrr * 0.9 + rh)} - ${maxHR}`,
      color: "border-red-500/20 text-red-400 bg-red-500/5",
      desc: "High intensity capacity, neural performance",
    },
  ];
  ...
  const showWeight = ["bmi", "bmr", "macro", "bodyfat", "water"].includes(
    activeTab,
  );
  const showHeight = ["bmi", "bmr", "macro", "bodyfat", "ibw"].includes(
    activeTab,
  );
  const showAge = ["bmr", "macro", "thr"].includes(activeTab);
  const showGender = ["bmr", "macro", "bodyfat", "ibw", "whr"].includes(
    activeTab,
  );
  ...
  const showHip =
    ["bodyfat", "whr"].includes(activeTab) &&
    (activeTab !== "bodyfat" || gender === "female");
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M12 3v1m0 16v1m9-9h-1M4 9h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
          />
      ...
      icon: (
        ...
        >
          ...
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M12 4v16M8 4v4M16 4v4M8 16v4M16 16v4"
          />
        </svg>
      ),
    },
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M3 10h18M6 5v10m12-10v10m-8-7h4"
          />
        </svg>
      ),
    },
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M20 13c0 5-3.5 7-8 7s-8-2-8-7c0-3.5 3-7.5 8-11.5 5 4 8 8 8 11.5z"
          />
        </svg>
      ),
    },
    ...
    <main className="min-h-screen bg-[#F5F5F7] text-[#1A1A1A] font-sans antialiased">
      ...
      <section className="relative h-[320px] md:h-[400px] w-full flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto space-y-3">
          <p className="text-xs text-[#1E00FA] font-bold uppercase tracking-[0.25em]">
            DATA-DRIVEN FITNESS ECOSYSTEM
          </p>
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-white leading-tight">
            {content?.hero_title ?? "Fitness & Nutrition Calculators"}
          </h1>
          <p className="text-gray-300 mt-2 text-sm md:text-base max-w-xl mx-auto leading-relaxed font-medium">
            {content?.hero_description ?? "Establish your baseline health metrics, training cardiovascular zones, and daily macronutrient targets using peer-reviewed physiological formulas."}
          </p>
        </div>
      </section>
      ...
      <section className="py-16 max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-5 bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col justify-between space-y-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {calcTabs.map((tab) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`mb-1.5 transition-colors ${isActive ? "text-[#1E00FA]" : "text-gray-400"}`}
                      >
                        {tab.icon}
                      </div>
            ...
            <div className="border-t border-gray-100 pt-6 space-y-5">
              ...
              {(showNeck || showWaist || showHip) && (
                <div className="space-y-4 pt-4 border-t border-gray-100">
                  <h4 className="text-xs font-bold text-[#1E00FA] uppercase tracking-widest">
                    Circumferences
                  </h4>
              ...
              {showActivity && (
                <div className="space-y-2 pt-4 border-t border-gray-100">
                  ...
                  >
                    <option value={1.2}>
                      Sedentary (Little to no daily movement)
                    </option>
                    <option value={1.375}>
                      Lightly Active (Training 1-3 times/week)
                    </option>
                    <option value={1.55}>
                      Moderately Active (Training 3-5 times/week)
                    </option>
                    <option value={1.725}>
                      Very Active (Heavy training 6-7 times/week)
                    </option>
                    <option value={1.9}>
                      Athlete / Extreme Labor (Twice daily training)
                    </option>
                  </select>
                </div>
              )}
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          setGoal(g.id as "loss" | "maintain" | "gain")
                        }
          ...
          <p className="text-[10px] text-gray-400 font-bold leading-relaxed pt-6 border-t border-gray-100 uppercase tracking-widest italic">
            *Calculated values are based on established clinical and
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6 animate-fadeIn">
                ...
                <div className="space-y-4 bg-white/5 border border-white/10 p-5 rounded-2xl">
                  <div className="flex justify-between text-xs font-bold uppercase tracking-wider">
                    <span>
                      Category:{" "}
                      <strong className={`font-extrabold ${bmiColor}`}>
                        {bmiCategory}
                      </strong>
                    </span>
                ...
                <p className="text-gray-400 text-xs leading-relaxed pt-2">
                  *Note: BMI is a general population screening tool. It does not
                  measure body fat directly and may overestimate adiposity in
                  muscular athletic profiles.
                </p>
              </div>
            )}
              ...
              <div className="space-y-6 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white/5 border border-white/10 p-5 rounded-2xl">
                    ...
                    <p className="text-2xl font-bold mt-1 text-[#1E00FA]">
                      {(bmr / 24).toFixed(1)}{" "}
                      <span className="text-xs text-white">kcal</span>
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-5 rounded-2xl">
                    <p className="text-[10px] text-gray-400 uppercase font-bold tracking-wider">
                    ...
                    <p className="text-xs font-extrabold mt-2 text-white uppercase tracking-wider">
                      Mifflin-St Jeor
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl space-y-3">
                  ...
                  <p className="text-gray-400 text-xs leading-relaxed">
                    Your BMR is the baseline metabolic energy required to
                    maintain core vital biological processes (cardiac function,
                    cellular respiration, thermoregulation, neural activity) at
                    complete rest.
                  </p>
                </div>
              </div>
            ...
            {activeTab === "macro" && (
              <div className="space-y-6 animate-fadeIn">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white/5 border border-white/10 p-5 rounded-2xl">
                  ...
                  <div>
                    <p className="text-[10px] text-gray-400 uppercase font-bold tracking-wider text-[#1E00FA]">
                      Daily Target Calories
                    </p>
                    <p className="text-3xl font-extrabold mt-1 text-[#1E00FA]">
                      {targetCalories} kcal
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4 bg-white/5 border border-white/10 p-5 rounded-2xl">
                  <h4 className="text-xs font-bold uppercase tracking-widest text-[#1E00FA]">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs font-semibold">
                      ...
                      <span className="font-bold text-[#1E00FA]">
                        {macros.protein}g ({macros.protein * 4} kcal)
                      </span>
                    </div>
                    <div className="w-full bg-white/10 h-2.5 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-[#1E00FA]"
                        style={{ width: `${goal === "loss" ? 40 : 30}%` }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs font-semibold">
                      ...
                      <span className="font-bold text-blue-400">
                        {macros.carbs}g ({macros.carbs * 4} kcal)
                      </span>
                    </div>
                    <div className="w-full bg-white/10 h-2.5 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${goal === "loss" ? 30 : goal === "gain" ? 50 : 40}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs font-semibold">
                      ...
                      <span className="font-bold text-yellow-400">
                        {macros.fat}g ({macros.fat * 9} kcal)
                      </span>
                    </div>
                    <div className="w-full bg-white/10 h-2.5 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-yellow-500"
                        style={{ width: `${goal === "gain" ? 20 : 30}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white/5 border border-white/10 p-5 rounded-2xl">
                    ...
                    <p className="text-2xl font-bold mt-1 text-emerald-400">
                      {leanMass} <span className="text-xs text-white">kg</span>
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-5 rounded-2xl">
                    <p className="text-[10px] text-gray-400 uppercase font-bold tracking-wider">
                    ...
                    <p className="text-2xl font-bold mt-1 text-red-500">
                      {fatMass} <span className="text-xs text-white">kg</span>
                    </p>
                  </div>
                </div>
            ...
            {activeTab === "ibw" && (
              <div className="space-y-6 animate-fadeIn">
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl space-y-3">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-gray-300">
                    Devine Formula Estimation
                  </h4>
                  <p className="text-gray-400 text-xs leading-relaxed">
                    The Devine Formula provides a clinical benchmark weight
                    based on height over 5 feet, adjusting per inch. This weight
                    represents an optimal health ratio baseline.
                  </p>
                  <div className="border-t border-white/5 pt-3">
                    <p className="text-[10px] text-gray-400 uppercase font-bold tracking-wider">
                      Equivalent Healthy BMI weight range
                    </p>
              ...
              <div className="space-y-6 animate-fadeIn">
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl space-y-4">
                  <div className="flex justify-between text-xs font-bold uppercase tracking-wider">
                    <span>
                      Cardiovascular Risk:{" "}
                      <strong className={`font-extrabold ${whrColor}`}>
                        {whrRisk}
                      </strong>
                    </span>
                    <span className="text-gray-400">
                      Threshold: {gender === "male" ? "< 0.90" : "< 0.80"}
                    </span>
                  </div>

                  <p className="text-gray-400 text-xs leading-relaxed">
                    WHR measures abdominal fat deposition. Higher ratios suggest
                    a concentration of visceral fat around core organs,
                    elevating risk profile for cardiovascular and metabolic
                    disorders.
                  </p>
                </div>
              </div>
            ...
            {activeTab === "onerm" && (
              <div className="space-y-6 animate-fadeIn">
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl space-y-3">
                  <h4 className="text-xs font-bold uppercase tracking-widest text-[#1E00FA] mb-1">
                    Sub-Maximal Load Projections
                  </h4>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-xs text-gray-400">
                    {repMaxes.map((item) => (
                      ...
                      >
                        <span>
                          {item.reps} Rep{item.reps > 1 ? "s" : ""} Target:
                        </span>
              ...
              <div className="space-y-5 animate-fadeIn">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white/5 border border-white/10 p-4 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold mt-0.5 text-[#1E00FA]">
                      {hrr} bpm
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="space-y-2">
                    {thrZones.map((zone) => (
                      <div
                        key={zone.zone}
                        className={`p-3.5 border rounded-xl flex items-center justify-between transition-all ${zone.color}`}
                      >
                        ...
                        <div className="text-right whitespace-nowrap">
                          ...
                          <p className="text-[9px] uppercase tracking-wider font-extrabold text-gray-500">
                            BPM Range
                          </p>
                        </div>
                      </div>
            ...
            {activeTab === "water" && (
              <div className="space-y-6 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white/5 border border-white/10 p-5 rounded-2xl flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-extrabold mt-1 text-sky-400">
                        {waterCups}{" "}
                        <span className="text-sm text-white">Cups</span>
                      </p>
                    </div>
                    <span className="text-[9px] text-gray-500 font-bold uppercase tracking-wider mt-2">
                      *1 Cup = 250ml
                    </span>
                  </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="w-12 h-16 border-2 border-sky-400 rounded-t-full rounded-b-3xl relative overflow-hidden flex items-end">
                        <div
                          ...
                          style={{
                            height: `${Math.min(100, (totalWater / 4.5) * 100)}%`,
                          }}
                        />
                      </div>
                      <div className="text-[10px] text-gray-400 font-semibold space-y-1">
                        <p>
                          • Baseline Weight Need: {baselineWater.toFixed(2)}L
                        </p>
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl">
                  ...
                  <p className="text-gray-400 text-xs leading-relaxed">
                    Sufficient hydration maintains joint lubrication, supports
                    optimal nutrient cellular delivery, improves athletic focus,
                    and speeds up exercise muscle cell recovery.
                  </p>
                </div>
              </div>
            )}
