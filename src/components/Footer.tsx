      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-10 mb-16">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-gray-400 leading-relaxed mb-6">
              A Singapore-based fitness and wellness group dedicated to building
              a refined, results-driven lifestyle ecosystem.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-extrabold text-[10px] tracking-[0.25em] text-maroon uppercase mb-6">
              Explore
            </h4>
            <ul className="space-y-3 text-xs text-gray-400">
              <li>
                <Link
                  href="/services"
                  className="hover:text-white hover:translate-x-1.5 transition-all duration-200 inline-block"
                >
                  Personal Training
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs text-gray-400">
              ...
              <li className="flex items-start gap-2">
                <svg
                  className="w-3.5 h-3.5 text-maroon mt-0.5"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <div className="flex flex-col text-[11px] leading-tight">
                  ...
                  <span className="text-gray-500 mt-1 font-semibold">
                    Johor Bahru, Malaysia (Gym)
                  </span>
                </div>
              </li>
            </ul>
        ...
        <div className="border-l-2 border-maroon/30 pl-4 mt-8">
          <p className="text-[10px] text-gray-500 leading-relaxed italic max-w-5xl">
            * DISCLAIMER: Results may vary. Results are based on individual
            circumstances. Timeframes for results are not guaranteed.
            Consistency, nutrition structure, and dedication to the program are
            always required!
          </p>
        </div>
      </div>
