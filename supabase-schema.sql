-- =====================================================================
-- QUATRE FITNESS - COMPLETE SCHEMA & INITIAL SEED SQL FOR SUPABASE
-- =====================================================================
-- Run this script in the Supabase SQL Editor (https://supabase.com)
-- to create the page_content table, enable RLS, configure policies,
-- and seed default texts for all 10 pages instantly.
...
-- Create an index on page_slug for instant lookups
...
-- Allow anonymous inserts (for initial dashboard setups/seeding)
...
-- 3. Seed Default Content for all 10 pages
INSERT INTO public.page_content (page_slug, sections, updated_at) VALUES
(
  'home',
  '{
